...
2. Navigate to the folder where you want to keep the project.
   ...
   ```bash
   git clone /Users/keshavanand/Downloads/FTC/DecodeTestbot.git
   cd DecodeFTCMain
   ```
...
3Verify your remotes:
   ...
   You should see:
   ```
   origin    /Users/keshavanand/Downloads/FTC/DecodeTestbot.git (fetch)
   origin    /Users/keshavanand/Downloads/FTC/DecodeTestbot.git (push)
